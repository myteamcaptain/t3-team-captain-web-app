...
export const metadata: Metadata = {
  title: getAppNameAbv("Privacy Policy"),
};

export default function PrivacyPolicy() {
  return (
    <PageLayouts>
      <Wrapper className="flex-col items-start space-y-4 py-10 [&>h1]:text-[24px] [&>h1]:font-[600] [&>h2]:pt-4 [&>h2]:text-[20px] [&>h2]:font-[600] [&>h3]:font-[600] [&>h4]:font-[600] [&>ul]:list-disc [&>ul]:pl-8">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Team Captain Bot, the
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ZK Studios LLC, 11309 Barrington Way
              Austin, TX 78759.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to My Team Captain, accessible
              from{" "}
              <a
                href="https://team-captain-web-app.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://team-captain-web-app.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: myteamcaptain@gmail.com</li>
        </ul>
      </Wrapper>
    </PageLayouts>
  );
